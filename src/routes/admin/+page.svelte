	...
	<div class="card">
		...
		<form method="post" action="?/addPost">
			...
			<label for="imageUrl">
				Image URL
				<small
					>Paste a direct link to the featured image (used in the blog card and at the top of the
					post).</small
				>
				<input
					type="url"
			...
			<label for="description">
				Description
				<small
					>A one-sentence summary shown in the "Recent posts" sidebar and used for SEO meta tags.</small
				>
				<input
					type="text"
					name="description"
